...
const Discover = () => {
    return ( 
        <main className="mt-24 flex flex-col gap-y-5 md:gap-y-0 md:gap-x-5 md:flex-row md:justify-between items-center">
            <div className="w-[49%] min-w-[18rem] flex gap-x-2 bg-inkBlue text-white py-10 md:py-20 px-4 sm:px-6 md:px-8 xl:px-10 rounded-[20px] md:rounded-[30px]">
            ...
            <div className="w-[49%] min-w-[18rem] border border-[#DBDCE5] bg-[#E0E0E3] text-[#1B1B1C] py-10 px-4 sm:px-6 md:px-8 xl:px-10 rounded-[20px] md:rounded-[30px]">
