    ...
    <main className="mt-12 text-[#161618]">
      <form onSubmit={onSubmit}>
        <div className="flex flex-col gap-y-1">
          ...
          <input value={state.email} type="email" name="email" id="email"
        ...
        <div className="relative flex flex-col gap-y-1 mt-6">
          ...
          <input type={seen ? "text" : "password"} value={state.password} name="password" id="password"
            className="border border-[#E6E7E8] px-2 xl:px-4 py-3 focus:border-primary rounded-md focus:outline-none"
            placeholder="xxxxxxxxxxxxx"
            onChange={handleChange} />
          <div className="absolute top-[55%] right-4 cursor-pointer text-base sm:text-lg md:text-xl xl:text-2xl"
