...
const OverviewCard = ({coinName, balance, imgSrc}: OverviewCardProps) => {
    return ( 
        <main className="w-full p-4 md:p-6 xl:p-8 rounded-2xl shadow-xl text-xs md:text-sm xl:text-base font-semibold bg-white hover:bg-[#FAFAFA] duration-300">
            <Link href="/user/coin" className="flex flex-col gap-y-5">
                <div className="flex justify-between items-center font-medium">
                    ...
                    <p className="text-xs md:text-sm xl:text-base font-semibold">${balance}</p>
                </div>
