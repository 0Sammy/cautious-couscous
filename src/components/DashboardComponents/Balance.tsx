    ...
    return ( 
        <main className="bg-[#160959] rounded-2xl p-4 md:p-6 xl:p-8 flex flex-col gap-y-10 text-white shadow-xl">
            ...
            <div className="flex flex-col gap-y-5 font-semibold text-xs md:text-sm xl:text-base">
                ...
                <Link href="/user/overview" target="_blank" className="mx-auto w-1/2 bg-white text-[#160959] py-2 md:py-3 text-center rounded-2xl border border-white hover:bg-inherit hover:text-white duration-500">Buy</Link>
            </div>
        </main>
     );
}
