...
const OnePlatform = () => {
    return ( 
        <main className="py-10 md:py-20 px-4 sm:px-6 md:px-8 xl:px-10 rounded-[20px] md:rounded-[30px] mt-20 gradientLightBlueToBlue text-xs md:text-sm xl:text-base">
