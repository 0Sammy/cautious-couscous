        ...
        <main className="relative gradientYellowToPink z-10 -mt-32 md:-mt-40 py-10 md:py-20 px-4 sm:px-6 md:px-8 xl:px-10 rounded-[20px] md:rounded-[30px]">
            ...
            <div className="rounded-[20px] p-5 bg-white border border-[#DBDCE5] lg:rounded-[30px] lg:p-8 m-auto mt-6 flex w-full flex-col-reverse justify-between gap-7 text-left md:flex-row md:items-center md:py-14">
                <div>
                    ...
                    <p className="my-5 max-w-[40ch] text-xs md:text-sm xl:text-base">Take control of your crypto. Avoid complicated steps and deposit directly to your wallet from exchanges like Binance and Coinbase.</p>
                    <Link href="/create" className="relative z-10 flex items-center justify-center gap-3 w-fit cursor-pointer text-xs md:text-sm xl:text-base px-8 py-[1.125rem] md:py-3 md:px-10 border border-inkBlue text-inkBlue hover:bg-inkBlue hover:text-white duration-300 rounded-full font-medium">Get started with deposits</Link>
                </div>
