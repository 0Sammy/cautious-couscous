                    ...
                    <ul className="flex items-stretch gap-6 overflow-auto">
                        <li className="min-w-[150px] md:min-w-[375px] lg:min-w-[unset] lg:flex-1 flex flex-col gap-y-5">
                            ...
                            <div>
                              ...
                              <p className="text-[#242426] mt-2">The easiest way to understand DeFi is to get your hands dirty. The Wealth Assets dApp Browser helped me to use protocols with small amounts and learn what works and what doesn&apos;t work.</p>
                            </div>
                        </li>
                        <li className="min-w-[150px] md:min-w-[375px] lg:min-w-[unset] lg:flex-1 flex flex-col gap-y-5">
                            ...
                            <div>
                              ...
                              <p className="text-[#242426] mt-2">Secure your private keys like your life depends on it. #DoNotShare 🔑</p>
                            </div>
                        </li>
                        <li className="min-w-[150px] md:min-w-[375px] lg:min-w-[unset] lg:flex-1 flex flex-col gap-y-5">
                            ...
                            <div>
                              ...
                              <p className="text-[#242426] mt-2">As a newcomer in this field, the introduction of blockchain technology has had a profound and transformative impact on my life. It has opened up an entirely new realm of possibilities that I am eager to explore.</p>
                            </div>
                        </li>
                        <li className="min-w-[150px] md:min-w-[375px] lg:min-w-[unset] lg:flex-1 flex flex-col gap-y-5">
                            <div className="relative">
