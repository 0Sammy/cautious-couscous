...
const page = () => {
    ...
    return ( 
        <main className="w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%] flex flex-col gap-y-5 items-center justify-center h-screen mx-auto">
            ...
            <p className="text-[#8E8E93] font-medium">Your Account is Temporarily Suspended. You have the option to submit an appeal for review. Our team will carefully assess your appeal to determine the reinstatement of your account.</p>
