...
const page = async ({ params }: { params: { id: string } }) => {
    ...
    return ( 
        <main>
                ...
                <div className="flex flex-col gap-y-3 lg:gap-y-0 lg:flex-row lg:justify-between">
                    <div className="lg:w-[40%] border border-[#7676801F] p-4 rounded-xl">
                      <p className="font-semibold text-white">
                        ...
                        <div className="flex flex-col gap-y-2 text-[#F0F0F0] mt-4">
                    ...
                    <div className="lg:w-[58%] border border-[#7676801F] p-4 rounded-xl">
                      ...
                      <div className="flex flex-col gap-y-2 lg:gap-y-0 lg:flex-row lg:gap-x-2 mt-8 text-[#F0F0F0]">
            ...
            <div className="mt-8 flex flex-col gap-y-2 text-[#F0F0F0] ">
              <div className="flex gap-x-1">
              ...
              <p className=" font-semibold text-[#F0F0F0] mt-4">Account Details</p>
              <div className="flex gap-x-1">
